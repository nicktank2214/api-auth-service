package com.armadillo.api.authservice.security;
...
import com.armadillo.api.bean.Constants;
...
class TokenAuthenticationService {
	...
	protected static final String INFORMATION_001 = 
			"\"message_code\":\"001\","
	...
	static void addAuthentication(HttpServletResponse res, String username) {
		...
		String resMessage = "{"+INFORMATION_001+","+"\"bearer_token\":\""+JWT+"\"}";
